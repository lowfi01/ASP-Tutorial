...
namespace ASP_Tutorial
{
    ...
    public partial class Entities : DbContext
    {
        ...
        [DbFunction("Entities", "funcGetAuthorCourses")]
        public virtual IQueryable<funcGetAuthorCourses_Result> funcGetAuthorCourses(Nullable<int> authorID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<funcGetAuthorCourses_Result>("[Entities].[funcGetAuthorCourses](@AuthorID)", authorIDParameter);
        }
